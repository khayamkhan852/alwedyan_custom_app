...
from alwedyan_custom_app.controllers.selling_controller import SellingController
...
class ProformaInvoice(SellingController):
	...
	if TYPE_CHECKING:
		...
		from alwedyan_custom_app.alwedyan_custom_app.doctype.proforma_invoice_item.proforma_invoice_item import ProformaInvoiceItem
